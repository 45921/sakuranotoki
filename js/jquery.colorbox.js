...
(function($, document, window) {
    ...
    function launch(element) {
        ...
        if (!closing) {
            ...
            if (!open) {
                ...
                //追記
                $(".controller").css('background-color', 'rgba(189,204,212,0)');
                $(".controller").eq(index).css('background-color', 'rgba(189,204,212,1)');
                //;追記
            }
    ...
    $(window).on('load', function() {
        ...
        function onTouchStart(event) {
            position1 = event.originalEvent.changedTouches[0].pageX;
            direction1 = '';
        }

        function onTouchMove(event) {
            if (position1 - event.originalEvent.changedTouches[0].pageX > 70) {
                direction1 = 'left';
            } else if (position1 - event.originalEvent.changedTouches[0].pageX < -70) {
                direction1 = 'right';
            }
        }
    ...
    // 追記
    // $("#cboxCurrent").remove();
    // var content = $(".others_modal_box_sp");
    // var contentArr = []
    ...
    $(document).on("click", ".controller", function() {
        $(".controller").css('background-color', 'rgba(189,204,212,0)');
        $(this).css('background-color', 'rgba(189,204,212,1)');
    ...
    $(window).on('resize', function() {
        if (windoWidth >= 700) {
            if ($('#colorbox').hasClass("cbox_otherSlide_sp") || $('#colorbox').hasClass("cbox_gallerySlide_sp")) {
                publicMethod.close();
            }
        } else {
            if ($('#colorbox').hasClass("cbox_otherSlide") || $('#colorbox').hasClass("cbox_gallerySlide")) {
                publicMethod.close();
            }
        }
    });
